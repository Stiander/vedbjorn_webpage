...
import classes from './OngoingRouteTableItem.module.css';

const OngoingRouteTableItem = (props) => {
    ...
    return (
        <div className={cardClass} onClick={cardClicked}>
            ...
            <p className={classes.paragraph2}>{props.visit.bagStr}</p>
...
export default OngoingRouteTableItem;
